            ...
            {!file ? (
              ...
              >
                ...
                <p className="text-muted-foreground mb-6 max-w-xs">
                  Drag and drop your PDF lecture notes here to start learning.
                </p>
              ...
              >
                ...
                <h3 className="text-lg font-semibold mb-2 text-center">Analyzing PDF...</h3>
              ...
              >
                ...
                <div className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white/5 border border-white/10 mb-6">
                  ...
                  <button onClick={() => setFile(null)} className="ml-2 hover:text-red-500">
                    <X className="w-4 h-4" />
                  </button>
                </div>
                <Button className="rounded-full px-8 glow" onClick={() => window.location.href='/study/demo'}>
                  Go to Study View
                </Button>
              </motion.div>
            )}
